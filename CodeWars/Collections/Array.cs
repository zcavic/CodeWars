...
namespace CodeWars.Collections
{
    public static class Array
    {
        ...
        public static int MaxSubArray(int[] A, int n1)
        {
            int sum = 0;
            int tempSum = 0;
            int i = 0;
        ...
        public static List<List<int>> diagonal(List<List<int>> A)
        {
            ...
            List<List<int>> res = new List<List<int>>(A.Count);
            for (int row = 0; row < A.Count + A.Count - 1; row++)
            {
        ...
        static public int maximumGap(List<int> A)
        {
            if (A.Count == 1)
                return 0;
            int j = 0;
